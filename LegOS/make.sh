...
i686-elf-gcc -c lib/memleg.c -o Binaries/memleg.o -std=gnu99 -ffreestanding
...
i686-elf-gcc -c lib/stdleg.c -o Binaries/stdleg.o -std=gnu99 -ffreestanding
i686-elf-gcc -c terminal.c -o Binaries/terminal.o -std=gnu99 -ffreestanding

echo "linking files"
i686-elf-gcc -T linker.ld -o myos.bin -ffreestanding -O2 -nostdlib Binaries/BootLeg.o Binaries/isrmacro.o Binaries/terminal.o Binaries/gdtentr.o Binaries/irqhandler.o Binaries/datastruct.o Binaries/ps2_keyboard.o Binaries/VGA_driver.o Binaries/gdt.o Binaries/isr.o Binaries/irq.o Binaries/ps2_driver.o Binaries/in-out.o Binaries/mathlib.o Binaries/shapes.o Binaries/fonts.o Binaries/stringlib.o Binaries/lidt.o Binaries/picmod.o Binaries/intf.o Binaries/pit.o Binaries/stdleg.o Binaries/memleg.o -lgcc
